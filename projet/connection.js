 ...
 * @returns Ouverture ou création de la base de données.
 */
    ...
    .catch(() => {
        ...
        return createOrOpenDatabase().then((connection) => {
            connection.exec(
                ...
                INSERT INTO Lires(id_livre,nom_livre,id_type_livre) 
                VALUES ((1,"Android Studio",5),(2,"Astronomy",8),(3,"HTML&CSS",5));
                INSERT INTO TypeUtilisateur(id_type_utilisateur,nom_type_utilisateur)
                VALUES ((1,"Administrateur"),(2,"Membre"));
                INSERT INTO Utilisateurs(id_utilisateur,nom_utilisateur,mot_de_passe,email,ville,addresse,province,id_type_utilisateur)
                VALUES (1,"Marc",1,"marc@hotmail.com","Aylmer","395 Rue des Perdrix","QC",1);
                `
            );
            return connection;
        });
